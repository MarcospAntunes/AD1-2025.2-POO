...
public class ProdutorService {
  ...
  public boolean removerProdutor(int ID) { return produtores.removeIf(produtor -> produtor.getID() == ID); }
  public List<Produtor> listarProdutores() { return new ArrayList<>(produtores); }
